...
@Component({
  selector: 'agencyDataManager-component',
  templateUrl: './agencyDataManager.component.html',
  imports: [CommonModule],
  styleUrls: ['./agencyDataManager.component.css'],
})
export class AgencyDataManagerComponent implements OnInit {
  immobili: Immobile[] = [];
